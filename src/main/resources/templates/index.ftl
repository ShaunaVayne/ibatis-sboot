    ...
    <div class="wrapper">
            ...
            <form action="${request.contextPath}/countries" method="post">
                <table class="gridtable" style="width:100%;">
                        ...
                        <th>国家(地区)名称: </th>
                            <td>
                                <input type="text" name="countryname"
                                 value="<#if queryParam.countryname ??>${queryParam.countryname}</#if>"/>
                            </td>
                        <th>国家(地区)代码: </th>
                            <td>
                                <input type="text" name="countrycode"
                                 value="<#if queryParam.countrycode ??>${queryParam.countrycode}</#if>"/>
                            </td>
                    ...
                    <tr>
                        <th>页码: </th>
                        <td>
                            <input type="text" name="page" value="${page!0}"/>
                        </td>
                        <th>页面大小: </th>
                        <td>
                            <input type="text" name="rows" value="${rows!10}">
                        </td>
                    </tr>
                </table>
            </form>
            ...
            <tbody>
                <#list pageInfo.list as country >
                    <tr>
                        ...
                        <td>
                            [<a href="${request.contextPath}/countries/view/${country.id}">修改</a>] -
        ...
        <table class="gridtable" style="width:100%;text-align: center;">
            ...
            <#if pageInfo.hasPreviousPage>
                ...
                <td>
                    <a href="${request.contextPath}/countries?page=${pageInfo.prePage}&rows=${pageInfo.pageSize}&countryname=${queryParam.countryname}&countrycode=${queryParam.countrycode}">上一页</a>
                </td>
            </#if>
            <#list pageInfo.navigatepageNums as nav>
                ...
                <#if nav != pageInfo.pageNum>
                    <td>
                        <a href="${request.contextPath}/countries?page=${pageInfo.nextPage}&rows=${pageInfo.pageSize}&countryname=<#if queryParam.countryname??>${queryParam.countryname}</#if>&countrycode=<#if queryParam.countrycode??>${queryParam.countrycode}</#if>">${nav}</a>
                    </td>
                </#if>
            </#list>
